...
<div>
    ...
    <div  class="layui-row"    align="center">
        ...
        <div  >
            ...
            <form id="form-userid" method="post" action="${pageContext.request.contextPath}/department/delSelected" >
            <table class="layui-table" >
                ...
                <tbody>   <%--   varStatus:遍历的状态信息            --%>
                 <c:forEach varStatus="did" items="${pageInfos.list}" var="dep">
                <tr>
                    <c:if test="${pageContext.session.getAttribute('user_identity')==1}">
                    <th><input type="checkbox" name="did" value="${dep.dep_id}"> </th>
                    </c:if>
                    <th>${did.count}</th>
                    <th>${dep.dep_id}</th>
                    <th>${dep.dep_name}</th>
                    ...
                    <th><div class="layui-btn-group">
                        <a type="button" class="layui-btn layui-btn-sm" href="${pageContext.request.contextPath}/department/findOne?did=${dep.dep_id}">编辑</a>
                        <a type="button" class="layui-btn layui-btn-sm" onclick="del(${dep.dep_id})">删除</a>
                    </div>
                    </th>
                    </c:if>
                </tr>
            ...
            <div class="box-tools pull-right">
                <ul class="pagination">
                    <li ><a href="${pageContext.request.contextPath}/department/findAll?page=1&size=5" aria-label="Previous">首页</a> </li>
                    <li ><a href="${pageContext.request.contextPath}/department/findAll?page=${pageInfos.pageNum-1}&size=5"  >上一页</a> </li>
                    <c:forEach begin="1" end="${pageInfos.pages}"  var="pageNumer">
                        <li><a href="${pageContext.request.contextPath}/department/findAll?page=${pageNumer}&size=5">${pageNumer}</a></li>
                    </c:forEach>
                    <li ><a href="${pageContext.request.contextPath}/department/findAll?page=${pageInfos.pageNum+1}&size=5"  >下一页</a> </li>
                    <li ><a href="${pageContext.request.contextPath}/department/findAll?page=${pageInfos.pages}&size=5"  >尾页</a> </li>
                </ul>
            </div>
            </form>
        </div>
...
<script>
    ...
    function del(aid) {
        ...
        if (flag){
            location.href="${pageContext.request.contextPath}/department/deleteById?dep_id="+aid;
        }
